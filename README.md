...
This project is hosted on [GitHub pages](#deployment), so if you want to check it online, please click 😊 [here](https://mariamosman11.github.io/todo-list-test/dist/).
...
-  Clone the repository
  ...
  ```sh
        git clone https://github.com/siddghosh108/Todo-List-Test.git
  ```
